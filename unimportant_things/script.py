...
mytext = 'You look absolutely horrendous today. If you can, please stay out of my sight. It hurts to look at you.'
...
if len(face_names) == 1:
    try:
        ...
        while (not correctName):
            mytext = "Hello! What is your name?"
            ...
            mytext = "You're name is " + name + ", right?"
            myobj = gTTS(text=mytext, lang=language, slow=False) 
            myobj.save("name.mp3") 
            playsound('name.mp3')
